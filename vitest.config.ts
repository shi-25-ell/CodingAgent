  ...
  test: {
    coverage: {
      ...
      include: [
        ...
        "packages/model/src/api/contracts.ts",
        "packages/model/src/catalog/model-registry.ts",
        "packages/model/src/providers/openai-compatible/index.ts",
        ...
        "packages/model/src/streaming/turn-accumulator.ts",
        ...
        "packages/agent/src/contracts/primitives.ts",
        ...
        "packages/agent/src/testing/controls.ts",
        ...
        "packages/coding/src/skills/**/*.ts",
        "packages/coding/src/testing/deterministic-composition.ts",
        ...
        "packages/coding/src/tools/web/index.ts",
